...
def community_chest(sq):
    match random.randrange(16):
        case 0: return SQ.GO
        case 1: return SQ.JAIL
        case _: return sq    # nop
...
def chance_card(sq):
    ...
    def next_r(sq):
        match sq:
            case SQ.CH1: return SQ.R2
            case SQ.CH2: return SQ.R3
            case SQ.CH3: return SQ.R1
            case _: assert False, 'bad square'

    # Utility Company
    def next_u(sq):
        match sq:
            case SQ.CH1 | SQ.CH3: return SQ.U1
            case SQ.CH2: return SQ.U2
            case _: assert False, 'bad square'
    ...
    match random.randrange(16):
        ...
        case 4: return SQ.H2
        case 5: return SQ.R1
        case 6: return next_r(sq)
        case 7: return next_r(sq)
        case 8: return next_u(sq)
        case 9: return (sq + 37) % 40    # go back three squares
        case _: return sq    # nop

def monte_carlo(dice, loop_cnt):
    random.seed()
    counter = [0] * 40
    sq = SQ.GO
    double = 0
...
def compute(faces, n_attempts, loop_cnt):
    def make_dice(faces):
        def throw_die():
            return random.randint(1, faces)
        return throw_die
